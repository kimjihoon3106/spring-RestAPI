package springrestAPI.springrestAPI.auth.controller;
...
import springrestAPI.springrestAPI.auth.config.auth.PrincipalDetails;
...
public class indexController {
    ...
    public @ResponseBody String testLogin(PulsarProperties.Authentication authentication,
